...
If you want to darken the image, use `img_to_dark: TRUE`. [This will help make the text on top of it easier to read](https://twitter.com/steveschoger/status/888021897782362114). Please note this only works if your logo is in SVG format. 

You can also add `logo_to_white: TRUE` to transform your logo into a white version. This is helpful if the cover image is dark and you want to make sure your logo is visible. 
